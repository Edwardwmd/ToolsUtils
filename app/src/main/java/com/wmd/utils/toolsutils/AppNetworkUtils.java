            ...
            if (currentNetWork == ConnectivityManager.TYPE_MOBILE) {
                if (networkInfo.getExtraInfo() != null) {
                    if (networkInfo.getExtraInfo().equals("cmnet")) {
                        AppLogMessageUtils.i("AppNetworkMgr", "当前网络为中国移动CMNET网络");
                        return TYPE_MOBILE_CMNET;
                    }
                    if (networkInfo.getExtraInfo().equals("cmwap")) {
                        AppLogMessageUtils.i("AppNetworkMgr", "当前网络为中国移动CMWAP网络");
                        return TYPE_MOBILE_CMWAP;
                    }
                    if (networkInfo.getExtraInfo().equals("uniwap")) {
                        AppLogMessageUtils.i("AppNetworkMgr", "当前网络为中国联通UNIWAP网络");
                        return TYPE_MOBILE_UNIWAP;
                    }
                    if (networkInfo.getExtraInfo().equals("3gwap")) {
                        AppLogMessageUtils.i("AppNetworkMgr", "当前网络为中国联通3GWAP网络");
                        return TYPE_MOBILE_3GWAP;
                    }
                    if (networkInfo.getExtraInfo().equals("3gnet")) {
                        AppLogMessageUtils.i("AppNetworkMgr", "当前网络为中国联通3GNET网络");
                        return TYPE_MOBLIE_3GNET;
                    }
                    if (networkInfo.getExtraInfo().equals("uninet")) {
                        AppLogMessageUtils.i("AppNetworkMgr", "当前网络为中国联通UNINET网络");
                        return TYPE_MOBILE_UNINET;
                    }
                    if (networkInfo.getExtraInfo().equals("ctwap")) {
                        AppLogMessageUtils.i("AppNetworkMgr", "当前网络为中国电信CTWAP网络");
                        return TYPE_MOBILE_UNINET;
                    }
                    if (networkInfo.getExtraInfo().equals("ctnet")) {
                        AppLogMessageUtils.i("AppNetworkMgr", "当前网络为中国电信CTNET网络");
                        return TYPE_MOBILE_UNINET;
                    }
                }
                //WIFI网络类型
            } else if (currentNetWork == ConnectivityManager.TYPE_WIFI) {
                AppLogMessageUtils.i("AppNetworkMgr", "当前网络为WIFI网络");
                return TYPE_WIFI;
            }
        }
        AppLogMessageUtils.i("AppNetworkMgr-->>NetworkUtils", "当前网络为不是我们考虑的网络");
        return TYPE_NO;
    }
        ...
        if (context != null) {
            ...
            if (mNetworkInfo != null) {
                ...
                if (ConnectivityManager.TYPE_MOBILE == mNetworkInfo.getType()) {
                    AppLogMessageUtils.i("AppNetworkMgr", "网络连接类型为：TYPE_MOBILE");
                    //判断移动网络连接状态
                    ...
                    if (STATE_MOBILE == NetworkInfo.State.CONNECTED) {
                        AppLogMessageUtils.i("AppNetworkMgrd", "网络连接类型为：TYPE_MOBILE, 网络连接状态CONNECTED成功！");
                        return mNetworkInfo.isAvailable();
                    }
                }
                //判断是TYPE_WIFI网络
                if (ConnectivityManager.TYPE_WIFI == mNetworkInfo.getType()) {
                    AppLogMessageUtils.i("AppNetworkMgr", "网络连接类型为：TYPE_WIFI");
                    //判断WIFI网络状态
                    ...
                    if (STATE_WIFI == NetworkInfo.State.CONNECTED) {
                        AppLogMessageUtils.i("AppNetworkMgr", "网络连接类型为：TYPE_WIFI, 网络连接状态CONNECTED成功！");
                        return mNetworkInfo.isAvailable();
                    }
                }
            }
